...
import {
  Car, MapPin, Loader2, CheckCircle, Trash2, ImageIcon, CreditCard, Copy, Check, Gauge, Star, Zap,
} from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
        ...
        >
          ...
          <button type="button" onClick={() => router.push("/")} className="px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-2xl transition-all">
            {t("go_home")}
          </button>
        </motion.div>
      </div>
      ...
      <div className="container mx-auto px-4 py-10 pb-32 max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-6 space-y-5">
            ...
            {/* Car Type */}
            <div>
              <label className="block text-sm font-semibold text-gray-400 mb-3">{tCar("car_type")}</label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" required placeholder="Toyota, BMW..."
              ...
              <div>
                ...
                <input type="text" required placeholder="Corolla, X5..."
                  className="w-full bg-white/5 border border-white/10 text-white rounded-2xl py-3 px-4 outline-none focus:ring-2 focus:ring-orange-500 placeholder:text-gray-600"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="number" required placeholder="2020" min="1990" max="2099"
                  className="w-full bg-white/5 border border-white/10 text-white rounded-2xl py-3 px-4 outline-none focus:ring-2 focus:ring-orange-500 placeholder:text-gray-600"
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="text" placeholder="Blanc, Noir..."
                  className="w-full bg-white/5 border border-white/10 text-white rounded-2xl py-3 px-4 outline-none focus:ring-2 focus:ring-orange-500 placeholder:text-gray-600"
                ...
                <CldUploadWidget uploadPreset={uploadPreset} onSuccess={handleUploadSuccess} options={{ multiple: true, maxFiles: 10 }}>
                  {({ open }) => (
                    <button type="button" onClick={() => open()}
                      className="w-full h-36 border-2 border-dashed border-white/10 hover:border-orange-500/40 rounded-2xl flex flex-col items-center justify-center gap-3 transition-all group">
                      <ImageIcon className="w-8 h-8 text-gray-600 group-hover:text-orange-400" />
          ...
          <button type="submit" disabled={loading}
            className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-5 rounded-3xl shadow-xl shadow-orange-500/20 flex items-center justify-center gap-3 transition-all active:scale-[0.98] disabled:opacity-70 text-lg"
          >
