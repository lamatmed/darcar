...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950 relative overflow-hidden px-4 py-12">
      ...
      {/* Orbs décoratifs */}
      <div className="absolute top-[-120px] left-[-120px] w-[400px] h-[400px] rounded-full bg-blue-600/20 blur-[100px] pointer-events-none" />
      <div className="absolute bottom-[-100px] right-[-100px] w-[350px] h-[350px] rounded-full bg-orange-500/15 blur-[100px] pointer-events-none" />
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">{locale === "ar" ? "تسجيل الدخول إلى حسابك" : "Connectez-vous à votre compte"}</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-7 shadow-2xl">
          ...
          {success && (
            <motion.div
              initial={{ opacity: 0, y: -8 }}
              animate={{ opacity: 1, y: 0 }}
              className="mb-5 flex items-center gap-3 bg-green-500/10 border border-green-500/20 text-green-400 p-3.5 rounded-2xl text-sm font-bold"
            >
